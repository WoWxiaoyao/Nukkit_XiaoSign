...
public class Lang
{
    ...
    public static String NullReward = "&c服务器设定奖励异常,请联系管理处理.";
    ...
    public static String SuccessCanRecoup = "&a补签成功!";
    public static String FailCanRecoup = "&c补签失败.";
    public static String SuccessRun = "&a执行成功!";
